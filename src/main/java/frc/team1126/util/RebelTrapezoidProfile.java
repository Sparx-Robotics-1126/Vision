 ...
 */
public class RebelTrapezoidProfile {
   ...
   */
  public RebelTrapezoidProfile(Constraints constraints) {
  ...
  public State calculate(double t, State current, State goal) {
    ...
    State result = new State(m_current.position, m_current.velocity, 0);
